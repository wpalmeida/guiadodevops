resource "oci_core_vcn" "guiadodevops" {
  compartment_id = var.compartment_id
  cidr_block = var.vcn_cidr_block
  display_name = var.vcn_display_name
  dns_label = "guiadodevops"
}
...
resource "oci_core_internet_gateway" "igw" {
	...
	display_name = "igw"
	enabled = "true"
	vcn_id = oci_core_vcn.guiadodevops.id
}
...
resource "oci_core_default_route_table" "default_route_table" {
	...
	manage_default_resource_id = oci_core_vcn.guiadodevops.default_route_table_id
}
